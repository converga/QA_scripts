...
* `mass_cancellation.py` - опционалньый скрипт для массовой очистки подписок с аккаунтов
  * `json2_cancel.json` - файл с базовой структурой для продукта, нужен для скрипта удаления подписок

reg_script:

* `ms_reg_script.py` - регистрация нужного количества аккаунтов через REMAP
...
* При необходимости, можно почистить подписки скриптом `mass_cancellation.py`
